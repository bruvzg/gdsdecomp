...
protected:
	...
	static constexpr int bytecode_rev = 0x1add52b;
	static constexpr int engine_ver_major = 3;
	static constexpr int variant_ver_major = 2;
	static constexpr const char *bytecode_rev_str = "1add52b";
	static constexpr const char *engine_version = "3.0-dev1";
	static constexpr const char *max_engine_version = "";
	static constexpr int parent = 0x7124599;

	virtual Vector<GlobalToken> get_added_tokens() const override { return {GlobalToken::G_TK_PR_REMOTE, GlobalToken::G_TK_PR_SYNC, GlobalToken::G_TK_PR_MASTER, GlobalToken::G_TK_PR_SLAVE}; }
public:
