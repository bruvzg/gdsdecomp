...
protected:
	...
	static constexpr int bytecode_rev = 0x513c026;
	static constexpr int engine_ver_major = 3;
	static constexpr int variant_ver_major = 2;
	static constexpr const char *bytecode_rev_str = "513c026";
	static constexpr const char *engine_version = "3.0-dev3";
	static constexpr const char *max_engine_version = "";
	static constexpr int parent = 0x4ee82a2;

	virtual Vector<String> get_added_functions() const override { return {"char"}; }
public:
