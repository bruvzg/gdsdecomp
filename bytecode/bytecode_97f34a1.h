...
protected:
	...
	static constexpr int bytecode_rev = 0x97f34a1;
	static constexpr int engine_ver_major = 1;
	static constexpr int variant_ver_major = 2;
	static constexpr const char *bytecode_rev_str = "97f34a1";
	static constexpr const char *engine_version = "1.1-dev2";
	static constexpr const char *max_engine_version = "";
	static constexpr int parent = 0x2185c01;

	virtual Vector<String> get_added_functions() const override { return {"seed", "get_inst"}; }
public:
