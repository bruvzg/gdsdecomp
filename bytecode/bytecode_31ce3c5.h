...
protected:
	...
	static constexpr int bytecode_rev = 0x31ce3c5;
	static constexpr int engine_ver_major = 1;
	static constexpr int variant_ver_major = 2;
	static constexpr const char *bytecode_rev_str = "31ce3c5";
	static constexpr const char *engine_version = "1.0-dev3";
	static constexpr const char *max_engine_version = "";
	static constexpr int parent = 0x8c1731b;

	virtual Vector<String> get_added_functions() const override { return {"funcref"}; }
public:
