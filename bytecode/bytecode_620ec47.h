...
protected:
	...
	static constexpr int bytecode_rev = 0x620ec47;
	static constexpr int engine_ver_major = 3;
	static constexpr int variant_ver_major = 3;
	static constexpr const char *bytecode_rev_str = "620ec47";
	static constexpr const char *engine_version = "3.2-dev2";
	static constexpr const char *max_engine_version = "";
	static constexpr int parent = 0x7f7d97f;

	virtual Vector<String> get_added_functions() const override { return {"step_decimals"}; }
public:
