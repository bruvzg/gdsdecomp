...
protected:
	...
	static constexpr int bytecode_version = 8;
	static constexpr int bytecode_rev = 0x64872ca;
	static constexpr int engine_ver_major = 2;
	static constexpr int variant_ver_major = 2;
	static constexpr const char *bytecode_rev_str = "64872ca";
	static constexpr const char *engine_version = "2.0-dev4";
	static constexpr const char *max_engine_version = "";
	static constexpr int parent = 0x7d2d144;

	virtual Vector<String> get_added_functions() const override { return {"Color8"}; }
public:
