...
protected:
	...
	static constexpr int bytecode_version = 6;
	static constexpr int bytecode_rev = 0x30c1229;
	static constexpr int engine_ver_major = 2;
	static constexpr int variant_ver_major = 2;
	static constexpr const char *bytecode_rev_str = "30c1229";
	static constexpr const char *engine_version = "2.0-dev2";
	static constexpr const char *max_engine_version = "";
	static constexpr int parent = 0x48f1d02;

	virtual Vector<GlobalToken> get_added_tokens() const override { return {GlobalToken::G_TK_PR_ONREADY}; }
public:
