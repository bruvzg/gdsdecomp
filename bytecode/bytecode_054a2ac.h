...
protected:
	...
	static constexpr int bytecode_rev = 0x054a2ac;
	static constexpr int engine_ver_major = 3;
	static constexpr int variant_ver_major = 3;
	static constexpr const char *bytecode_rev_str = "054a2ac";
	static constexpr const char *engine_version = "3.0.0-stable";
	static constexpr const char *max_engine_version = "3.0.6-stable";
	static constexpr int parent = 0x91ca725;

	virtual Vector<String> get_added_functions() const override { return {"polar2cartesian", "cartesian2polar"}; }
public:
