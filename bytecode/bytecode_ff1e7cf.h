...
protected:
	...
	static constexpr int bytecode_rev = 0xff1e7cf;
	static constexpr int engine_ver_major = 3;
	static constexpr int variant_ver_major = 3;
	static constexpr const char *bytecode_rev_str = "ff1e7cf";
	static constexpr const char *engine_version = "3.1-dev1";
	static constexpr const char *max_engine_version = "";
	static constexpr int parent = 0x054a2ac;

	virtual Vector<String> get_added_functions() const override { return {"is_instance_valid"}; }
public:
