...
protected:
	...
	static constexpr int bytecode_rev = 0xf8a7c46;
	static constexpr int engine_ver_major = 3;
	static constexpr int variant_ver_major = 2;
	static constexpr const char *bytecode_rev_str = "f8a7c46";
	static constexpr const char *engine_version = "3.0-dev7";
	static constexpr const char *max_engine_version = "";
	static constexpr int parent = 0x62273e5;

	virtual Vector<GlobalToken> get_added_tokens() const override { return {GlobalToken::G_TK_CF_MATCH}; }
public:
