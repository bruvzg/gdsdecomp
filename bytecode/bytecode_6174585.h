...
protected:
	...
	static constexpr int bytecode_version = 9;
	static constexpr int bytecode_rev = 0x6174585;
	static constexpr int engine_ver_major = 2;
	static constexpr int variant_ver_major = 2;
	static constexpr const char *bytecode_rev_str = "6174585";
	static constexpr const char *engine_version = "2.0-dev5";
	static constexpr const char *max_engine_version = "";
	static constexpr int parent = 0x64872ca;

	virtual Vector<GlobalToken> get_added_tokens() const override { return {GlobalToken::G_TK_CONST_PI}; }
public:
