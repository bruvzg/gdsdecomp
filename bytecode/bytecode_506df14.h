...
protected:
	...
	static constexpr int bytecode_rev = 0x506df14;
	static constexpr int engine_ver_major = 4;
	static constexpr int variant_ver_major = 3;
	static constexpr const char *bytecode_rev_str = "506df14";
	static constexpr const char *engine_version = "4.0-dev1";
	static constexpr const char *max_engine_version = "";
	static constexpr int parent = 0x5565f55;

	virtual Vector<String> get_removed_functions() const override { return {"decimals"}; }
public:
