...
protected:
	...
	static constexpr int bytecode_rev = 0x8cab401;
	static constexpr int engine_ver_major = 1;
	static constexpr int variant_ver_major = 2;
	static constexpr const char *bytecode_rev_str = "8cab401";
	static constexpr const char *engine_version = "1.0-dev5";
	static constexpr const char *max_engine_version = "";
	static constexpr int parent = 0x703004f;

	virtual Vector<GlobalToken> get_added_tokens() const override { return {GlobalToken::G_TK_PR_YIELD}; }
public:
