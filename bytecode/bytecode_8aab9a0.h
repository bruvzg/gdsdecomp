...
protected:
	...
	static constexpr int bytecode_rev = 0x8aab9a0;
	static constexpr int engine_ver_major = 3;
	static constexpr int variant_ver_major = 3;
	static constexpr const char *bytecode_rev_str = "8aab9a0";
	static constexpr const char *engine_version = "3.1-dev6";
	static constexpr const char *max_engine_version = "";
	static constexpr int parent = 0xa3f1ee5;

	virtual Vector<GlobalToken> get_added_tokens() const override { return {GlobalToken::G_TK_PR_AS, GlobalToken::G_TK_PR_VOID, GlobalToken::G_TK_FORWARD_ARROW}; }
public:
