...
protected:
	...
	static constexpr int bytecode_version = 7;
	static constexpr int bytecode_rev = 0x7d2d144;
	static constexpr int engine_ver_major = 2;
	static constexpr int variant_ver_major = 2;
	static constexpr const char *bytecode_rev_str = "7d2d144";
	static constexpr const char *engine_version = "2.0-dev3";
	static constexpr const char *max_engine_version = "";
	static constexpr int parent = 0x30c1229;

	virtual Vector<GlobalToken> get_added_tokens() const override { return {GlobalToken::G_TK_PR_BREAKPOINT}; }
public:
