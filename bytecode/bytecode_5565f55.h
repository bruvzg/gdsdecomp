...
protected:
	...
	static constexpr int bytecode_rev = 0x5565f55;
	static constexpr int engine_ver_major = 3;
	static constexpr int variant_ver_major = 3;
	static constexpr const char *bytecode_rev_str = "5565f55";
	static constexpr const char *engine_version = "3.2.0-stable";
	static constexpr const char *max_engine_version = "3.4.5-stable";
	static constexpr int parent = 0x6694c11;

	virtual Vector<String> get_added_functions() const override { return {"ord"}; }
public:
