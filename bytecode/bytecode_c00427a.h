...
protected:
	...
	static constexpr int bytecode_rev = 0xc00427a;
	static constexpr int engine_ver_major = 3;
	static constexpr int variant_ver_major = 3;
	static constexpr const char *bytecode_rev_str = "c00427a";
	static constexpr const char *engine_version = "3.2-dev3";
	static constexpr const char *max_engine_version = "";
	static constexpr int parent = 0x620ec47;

	virtual Vector<String> get_added_functions() const override { return {"move_toward"}; }
public:
