...
protected:
	...
	static constexpr int bytecode_rev = 0x62273e5;
	static constexpr int engine_ver_major = 3;
	static constexpr int variant_ver_major = 2;
	static constexpr const char *bytecode_rev_str = "62273e5";
	static constexpr const char *engine_version = "3.0-dev6";
	static constexpr const char *max_engine_version = "";
	static constexpr int parent = 0x8b912d1;

	virtual Vector<String> get_added_functions() const override { return {"validate_json", "parse_json", "to_json"}; }
public:
