...
protected:
	...
	static constexpr int bytecode_rev = 0x216a8aa;
	static constexpr int engine_ver_major = 3;
	static constexpr int variant_ver_major = 3;
	static constexpr const char *bytecode_rev_str = "216a8aa";
	static constexpr const char *engine_version = "3.0-dev13";
	static constexpr const char *max_engine_version = "";
	static constexpr int parent = 0xd28da86;

	virtual Vector<String> get_added_functions() const override { return {"wrapi", "wrapf"}; }
public:
