...
protected:
	...
	static constexpr int bytecode_rev = 0x5e938f0;
	static constexpr int engine_ver_major = 3;
	static constexpr int variant_ver_major = 2;
	static constexpr const char *bytecode_rev_str = "5e938f0";
	static constexpr const char *engine_version = "3.0-dev9";
	static constexpr const char *max_engine_version = "";
	static constexpr int parent = 0xc24c739;

	virtual Vector<GlobalToken> get_added_tokens() const override { return {GlobalToken::G_TK_CONST_INF, GlobalToken::G_TK_CONST_NAN}; }
public:
