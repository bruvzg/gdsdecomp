...
protected:
	...
	static constexpr int bytecode_version = 1;
	static constexpr int bytecode_rev = 0x0b806ee;
	static constexpr int engine_ver_major = 1;
	static constexpr int variant_ver_major = 2;
	static constexpr const char *bytecode_rev_str = "0b806ee";
	static constexpr const char *engine_version = "1.0-dev1";
