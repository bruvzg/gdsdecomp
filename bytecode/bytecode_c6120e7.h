...
protected:
	...
	static constexpr int bytecode_rev = 0xc6120e7;
	static constexpr int engine_ver_major = 3;
	static constexpr int variant_ver_major = 3;
	static constexpr const char *bytecode_rev_str = "c6120e7";
	static constexpr const char *engine_version = "3.0-dev11";
	static constexpr const char *max_engine_version = "";
	static constexpr int parent = 0x015d36d;

	virtual Vector<String> get_added_functions() const override { return {"len"}; }
public:
